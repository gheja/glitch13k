...
var MAP_WIDTH = 68;
var MAP_HEIGHT = 37;
var MAP_DATA = "";
...
// DEBUG END
	...
	var LIMBO_DOOR6 = _objs[48];
	var LIMBO_DOOR7 = _objs[49];
	var TUT_DOOR2 = _objs[50];
	var TUT_CUBE1 = _objs[51];
	var TUT_SW1 = _objs[52];
	var TUT_DOOR3 = _objs[53];
	var TUT_DOOR4 = _objs[54];
	var TUT_DOOR5 = _objs[55];
	var TUT_DOOR6 = _objs[56];
	var TUT_DOOR7 = _objs[57];
	var TUT_CRYSTAL = _objs[58];
	var TUT_SW2 = _objs[59];
	var TUT_DOOR8 = _objs[60];
	var TUT_DOOR9 = _objs[61];
	var TUT_PORTAL1 = _objs[62];
	var TUT_SW3 = _objs[63];
	var TUT_PORTAL2 = _objs[64];
	var TUT_SW4 = _objs[65];
	var TUT_SW5 = _objs[66];
	var TUT_SW6 = _objs[67];
	var TUT_DOOR10 = _objs[68];
	var L4_POT1 = _objs[69];
	var L4_POT2 = _objs[70];
	var L4_POT3 = _objs[71];
	var L2_POT1 = _objs[72];
	var L2_POT2 = _objs[73];
	var L2_POT3 = _objs[74];
