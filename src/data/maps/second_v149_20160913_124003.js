...
var MAP_WIDTH = 68;
var MAP_HEIGHT = 37;
var MAP_DATA = "";
...
// DEBUG END
	...
	_objs.push(
		...
		new ObjSwitch(13, 32),
		new ObjSwitch(13, 33),
		new ObjPortal(16, 30, 3, 0, 2, 0, 0),
		new ObjPortal(19, 32, 2, 0, 1, 0, 0),
		new ObjPortal(21, 31, 2, 0, 1, 0, 0),
		new ObjPortal(23, 32, 2, 0, 1, 0, 0),
		new ObjDoor(56, 1, 2),
		new ObjDoor(63, 16, 1),
		new ObjDoor(55, 31, 0),
		new ObjDoor(63, 25, 0),
...
// DEBUG END
	...
	var LIMBO_DOOR8 = _objs[78];
	var TUT_DOOR2 = _objs[79];
	var TUT_CUBE1 = _objs[80];
	var TUT_SW1 = _objs[81];
	var TUT_DOOR3 = _objs[82];
	var TUT_DOOR4 = _objs[83];
	var TUT_DOOR5 = _objs[84];
	var TUT_DOOR6 = _objs[85];
	var TUT_DOOR7 = _objs[86];
	var TUT_CRYSTAL = _objs[87];
	var TUT_SW2 = _objs[88];
	var TUT_DOOR8 = _objs[89];
	var TUT_DOOR9 = _objs[90];
	var TUT_PORTAL1 = _objs[91];
	var TUT_SW3 = _objs[92];
	var TUT_PORTAL2 = _objs[93];
	var TUT_SW4 = _objs[94];
	var TUT_SW5 = _objs[95];
	var TUT_SW6 = _objs[96];
	var TUT_DOOR10 = _objs[97];
	var L4_POT1 = _objs[98];
	var L4_POT2 = _objs[99];
	var L4_POT3 = _objs[100];
	var L2_POT1 = _objs[101];
	var L2_POT2 = _objs[102];
	var L2_POT3 = _objs[103];
...
linkDoors(LIMBO_DOOR8, L5_DOOR6);
...
linkDoors(L4_DOOR2, L4_DOOR3);

linkDoors(L4_DOOR4, L4_DOOR_Y2);
...
linkDoors(LIMBO_DOOR1, BONUS_DOOR1);
LIMBO_DOOR2.targetDoor = TUT_DOOR1;
linkDoors(TUT_DOOR10, BONUS_DOOR2);
// }
