...
// DEBUG END
	...
	_objs.push(
		...
		new ObjSwitch(26, 3),
		new ObjDoor(11, 3, 1),
		new ObjPotion(34, 15, 0),
		new ObjPotion(36, 15, 0),
		new ObjPotion(35, 18, 2)
	);
	L2_LO1 = new LightsOut(34, 12, 3, 3, 3);

	MAP_OBJECT_NAMES = [ 'PLAYER', 'L2_PORTAL1', 'L2_DOOR1', 'L2_DOOR2', 'L1_DOOR1', 'L1_DOOR2', 'L1_DOOR3', 'L1_DOOR4', 'L1_SW1', 'L1_SW2', 'L1_PORTAL1', 'L1_CUBE1', 'L1_DOOR5', 'LIMBO_DOOR1', 'LIMBO_DOOR2', 'LIMBO_DOOR3', 'TUT_DOOR2', 'TUT_CUBE1', 'TUT_SW1', 'TUT_DOOR3', 'TUT_DOOR4', 'TUT_DOOR5', 'TUT_DOOR6', 'TUT_DOOR7', 'TUT_CRYSTAL', 'TUT_SW2', 'TUT_DOOR8', 'TUT_DOOR9', 'TUT_PORTAL1', 'TUT_SW3', 'TUT_PORTAL2', 'TUT_SW4', 'TUT_SW5', 'TUT_SW6', 'TUT_DOOR10', 'L2_POT1', 'L2_POT2', 'L2_POT3'];
...
// DEBUG END
	...
	var TUT_DOOR2 = _objs[16];
	var TUT_CUBE1 = _objs[17];
	var TUT_SW1 = _objs[18];
	var TUT_DOOR3 = _objs[19];
	var TUT_DOOR4 = _objs[20];
	var TUT_DOOR5 = _objs[21];
	var TUT_DOOR6 = _objs[22];
	var TUT_DOOR7 = _objs[23];
	var TUT_CRYSTAL = _objs[24];
	var TUT_SW2 = _objs[25];
	var TUT_DOOR8 = _objs[26];
	var TUT_DOOR9 = _objs[27];
	var TUT_PORTAL1 = _objs[28];
	var TUT_SW3 = _objs[29];
	var TUT_PORTAL2 = _objs[30];
	var TUT_SW4 = _objs[31];
	var TUT_SW5 = _objs[32];
	var TUT_SW6 = _objs[33];
	var TUT_DOOR10 = _objs[34];
	var L2_POT1 = _objs[35];
	var L2_POT2 = _objs[36];
	var L2_POT3 = _objs[37];
